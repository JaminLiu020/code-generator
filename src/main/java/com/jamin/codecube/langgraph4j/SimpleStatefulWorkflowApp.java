...
public class SimpleStatefulWorkflowApp {
    ...
    public static void main(String[] args) throws GraphStateException {
        ...
        CompiledGraph<MessagesState<String>> workflow = new MessagesStateGraph<String>()
                ...
                .addNode("prompt_enhancer", makeStatefulNode("image_collector", "增强提示词"))
                .addNode("router", makeStatefulNode("image_collector", "智能路由选择"))
                .addNode("code_generator", makeStatefulNode("image_collector", "网站代码生成"))
                .addNode("project_builder", makeStatefulNode("image_collector", "项目构建"))
