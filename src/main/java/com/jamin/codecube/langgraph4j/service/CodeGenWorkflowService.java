package com.jamin.codecube.langgraph4j.service;
...
public class CodeGenWorkflowService {
    ...
    @Autowired
    private CompiledGraph<MessagesState<String>> codeGenWorkflowGraph;
    ...
    public WorkflowContext executeWorkflow(String originalPrompt) {
        ...
        GraphRepresentation graph = codeGenWorkflowGraph.getGraph(GraphRepresentation.Type.MERMAID);
        log.info("工作流图:\n{}", graph.content());
        log.info("开始执行代码生成工作流");

        WorkflowContext finalContext = null;
        int stepCounter = 1;
        for (NodeOutput<MessagesState<String>> step : codeGenWorkflowGraph.stream(
